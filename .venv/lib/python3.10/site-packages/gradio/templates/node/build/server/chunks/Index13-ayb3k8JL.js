...
import { B as Block, S as Static, e as BlockLabel, W as Code$2, g as Empty, i as IconButton, K as Copy$1, D as Download$1, h as IconButtonWrapper } from './2-DuF4BbEW.js';
...
const lang_map = {
  python: () => import('./index27-D3fRAfNA.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index28-BF8bryxd.js'),
      import('./frontmatter-C3geu5YB.js')
    ]);
    return md.markdown({ extensions: [frontmatter.frontmatter] });
  },
  json: () => import('./index32-sAE8I2-m.js').then((m) => m.json()),
  html: () => import('./index29-DVy2MNpA.js').then((m) => m.html()),
  css: () => import('./index30-nYIIoT9Z.js').then((m) => m.css()),
  javascript: () => import('./index31-Ba_Cibc0.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index31-Ba_Cibc0.js').then(
...
//# sourceMappingURL=Index13-ayb3k8JL.js.map
